            ...
            <?php
                ...
                while($row = mysqli_fetch_array($table)){ ?>
                    <tr id="<?php echo $row['region_code']; ?>">
                        <td><input type="text" value="<?php echo $row['rcode'] ?>" name="" readonly></td>
                        <td data-target="lastName"><?php echo $row['region_name'] ?></td>
                        <td data-target="eMail"><?php echo $row['zone_long_description'] ?></td>
                        <td><a href="#" data-role="update" data-id="<?php echo $row['region_code']; ?>" data-toggle="modal" data-target="#myModal"><input type="button" value="update"></a></td>
