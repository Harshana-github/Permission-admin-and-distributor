<?php
	...
	if ( isset($_GET['territory']) ) {
		...
		$territory = mysqli_real_escape_string($connection, $_GET['territory']);
        ...
        INNER JOIN user ON addpurchaseorder.distributor=user.id WHERE addpurchaseorder.territory_code = {$territory}";
